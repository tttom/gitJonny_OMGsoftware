...
%
%
function deconvolveCubicLightSheet(experimentFilePath,detNA,PMalpha)
    if nargin<1 || isempty(experimentFilePath)
        rootFolder='E:\FatmaZohra-LightSheetData_2016-09-08\2016-09-08 18_47_55.289';
%         experimentFilePath=fullfile(rootFolder,'recording0_lambda532nm_alpha0_beta100\recording0_lambda532nm_alpha0_beta100.json');
%         experimentFilePath=fullfile(rootFolder,'recording0_lambda532nm_alpha7_beta100\recording0_lambda532nm_alpha7_beta100.json');
%         experimentFilePath=fullfile(rootFolder,'2015-12-02 12_08_21.071\recording0_lambda532nm_alpha0_beta100.json');
%         experimentFilePath=fullfile(rootFolder,'2015-12-02 12_08_21.071\recording0_lambda532nm_alpha-7_beta100.json');

%         experimentFilePath=fullfile(rootFolder,'2015-12-02 12_06_56.145\recording0_lambda488nm_alpha0_beta100');
        experimentFilePath=fullfile(rootFolder,'recording0_lambda532nm_alpha-7_beta100'); % NA 0.42
%         experimentFilePath=fullfile(rootFolder,'2015-12-09 20_36_13.395\recording0_lambda532nm_alpha-7_beta100'); % low NA excitation
%         experimentFilePath=fullfile(rootFolder,'2015-12-09 20_37_47.302\recording0_lambda532nm_alpha-7_beta100'); % low NA excitation
%         experimentFilePath=fullfile(rootFolder,'2015-12-09 20_37_47.302\recording0_lambda532nm_alpha0_beta100');  % low NA excitation
    end
...
%     config.detection.mask.beta=0; % use this for the classic cubic
    ...
    shearFactors = [0 0]; %[0.0008 -0.0019]; %[0.0673 -0.0133]; % it appears that the stage translates at an angle slightly non-orthogonal. That is ok as long as it doesn't change
